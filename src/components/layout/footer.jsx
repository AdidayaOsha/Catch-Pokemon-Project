...
function Footer() {
  return (
    <footer className="text-white bg-black lg:grid lg:grid-cols-5 mt-24">
      <aside className="hidden lg:relative lg:col-span-2 lg:block">
        <img
          className="absolute inset-0 object-cover w-full h-full"
          src="https://i.pinimg.com/originals/f8/fa/26/f8fa26c9b9ea2817a7c5a61845936964.jpg"
          alt="Comic Graphic"
        />
      </aside>
          ...
          <div>
            ...
            <div className="flex mt-16 space-x-3">
              <a
                ...
                href="https://www.instagram.com/oshaprima/"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                className="p-2 border rounded-full border-white/25 hover:opacity-75"
                href="https://twitter.com/AdidayaOsha"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                className="p-2 border rounded-full border-white/25 hover:opacity-75"
                href="https://github.com/AdidayaOsha"
                target="_blank"
                rel="noreferrer"
              >
